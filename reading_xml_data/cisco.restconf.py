...
# response hold the value of the request response after making a get request
...
# print(soup.prettify())
# print(soup.gigabitethernet) #Notice that now you have only printed XML data from the first gigabitethernet tag that the parser found.
