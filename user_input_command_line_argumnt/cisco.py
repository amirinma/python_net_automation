...
class CiscoIOS_CLI(CiscoIOS): # making this subclass of CiscoIOS
...
def main(): # python cisco.py 10.254.0.1 
    # csr = CiscoIOS(sys.argv[1], username='cisco', password='cisco')
    csr = CiscoIOS_CLI()
    print(csr.get_interface_list())
    print(csr)

if __name__ == '__main__': # conditional statement run the main() if this script is not running via import
    main()