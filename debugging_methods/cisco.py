...
class CiscoIOS():
    ...
    def get_interface_names(self):
        ...
        #return ip_int_br  #used for debugging to check what type of data ip_int_br is 
        df = pd.DataFrame(ip_int_br) # pd.xxx is expecting structured opject not unstructured text 
